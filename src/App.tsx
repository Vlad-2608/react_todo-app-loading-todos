...
export const App: React.FC = () => {
  ...
  return (
    <div className="todoapp">
        ...
        <section className="todoapp__main" data-cy="TodoList">
          {visibleTodos.map(todo => (
            ...
            >
              ...
              {/* Накладка покриватиме завдання, поки воно видаляється або оновлюється */}
              {/* Цей приклад поки що не має індивідуальних станів завантаження для завдань */}
              {/* <div data-cy="TodoLoader" className="modal overlay">
                <div className="modal-background has-background-white-ter" />
                <div className="loader" />
              </div> */}
      ...
      {/* НЕ використовуйте умовне відтворення для приховування сповіщення */}
      {/* Додайте клас 'hidden' для плавного приховування повідомлення */}
      <div
        data-cy="ErrorNotification"
      ...
      >
        ...
        />
        {/* Показувати лише одне повідомлення одночасно */}
        {error}
      </div>
    </div>
  );
